...
import { NAVIGATION_LOGS_DETAIL_SCREEN } from "constants/navigation.constant";
...
export default function LogsListItem({ item }: { item: any }) {
  ...
  return (
    <Pressable
      onPress={() =>
        navigateNavHelper(NAVIGATION_LOGS_DETAIL_SCREEN, {
          item,
        })
      }
      style={{
